// ===== CONFIGURACIÓN FINAL PARA TU PROYECTO - VERSIÓN MEJORADA =====
...
// Función de Login (mantener para compatibilidad)
...
// Función de Registro (mantener para compatibilidad)
...
// Función para cerrar sesión (mantener para compatibilidad)
...
// Función para recuperar contraseña - MEJORADA
...
// Nueva función para actualizar contraseña con token
...
// Nueva función para verificar la fortaleza de contraseña
...
// Configurar timeouts para requests
const originalFetch = window.fetch;
window.fetch = function(...args) {
    const [url, config] = args;
    
    // Solo aplicar timeout a requests de Supabase
    if (url && typeof url === 'string' && url.includes('supabase.co')) {
        ...
        return originalFetch(url, newConfig).finally(() => {
...
console.log('🔒 AuthManager integrado:', !!window.authManager);
